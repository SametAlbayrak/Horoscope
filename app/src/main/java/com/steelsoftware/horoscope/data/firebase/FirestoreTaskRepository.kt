...
import com.steelsoftware.horoscope.data.firebase.remote.mapToTask
...
class FirestoreTaskRepository : ITaskRepository {
    ...
    companion object {
        private const val TASKS_COLLECTION = "users"
        private const val TASK_FIELD_TITLE = "content"
        private const val TASK_FIELD_CREATED = "title"
    }
